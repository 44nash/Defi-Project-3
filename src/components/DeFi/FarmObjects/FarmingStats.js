      ...
      >
        {this.state.isStaking === true ? (
          ...
          <>
            ...
            >
              <b>You are not currently staking</b>
            </p>
          </>
        )}
        ...
        >
          <b>Staking Balance:</b> {this.state.stakingBalance}
        </p>
        <p
          style={{
            fontSize: '14px',
        ...
        >
          <b>Pump Balance:</b> {this.state.pumpBalance}
        </p>
        <p
          style={{
            fontSize: '14px',
        ...
        >
          <b>Start Time:</b> {this.state.startTime}
        </p>
        <button style={{ margin: '5px' }} onClick={this.getFarmStats}>
          refresh
        </button>
      </div>
    );
